...
[![Build fedora-41](https://github.com/buluma/fedora/actions/workflows/fedora-41.yml/badge.svg?branch=main)](https://github.com/buluma/fedora/actions/workflows/fedora-41.yml)
...
![Docker Image Size (tag)](https://img.shields.io/docker/image-size/buluma/fedora/41?logo=docker&logoColor=white&label=41)
